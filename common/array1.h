 ...
 *
 * Provides Array1<T>: a dynamic 1D array for plain-old-data (POD) types with automatic
 * memory management. Array1 supports most std::vector operations and uses assertions for
 * bounds checking rather than exceptions in most cases.
 */
